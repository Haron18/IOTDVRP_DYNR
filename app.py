...
sim_speed = st.sidebar.slider(
    "Fréquence de rafraîchissement serveur (sec)", 2, 30, 5,
    help="Intervalle entre deux resynchronisations côté Python (KPI, tableau GPS, "
         "nouvelles commandes). Le déplacement des camions sur la carte, lui, reste "
         "fluide en continu (animation React) quel que soit ce réglage — augmenter "
         "cette valeur réduit juste la charge serveur, sans casser l'animation.",
)
